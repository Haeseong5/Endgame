...
public class RankThemeActivity extends BaseActivity {
    ...
    private void updateUI(int gameIdx, String title) {
        Intent rankIntent = new Intent(RankThemeActivity.this, RankActivity.class);
    ...
    private void updateUI_ColorResult(ColorResult colorResult) {
        Intent resultIntent = new Intent(RankThemeActivity.this, ResultColorActivity.class);
